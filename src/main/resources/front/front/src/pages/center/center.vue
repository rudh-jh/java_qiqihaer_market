<template>
<div class="center-preview" :style='{"width":"80%","margin":"0 auto","position":"relative","flexWrap":"wrap","background":"#FCFAFF","display":"flex"}'>
	<div class="title" :style='{"margin":"10px 0","color":"#000","textAlign":"center","background":"linear-gradient(180deg, #A293B6 0%, rgba(241,231,255,0) 100%)","clipPath":"polygon(30px 00%, 0% 100%, 100% 100%, calc(100% - 30px) 0%)","width":"100%","fontSize":"20px","lineHeight":"54px","fontWeight":"bold"}'>{{ title }}</div>
	
	<div class="info" :style='{"padding":"40px 40px 40px 140px","boxShadow":"none","margin":"20px auto","borderRadius":"0","background":"none","width":"35%","position":"relative","height":"auto"}'>
		<div :style='{"borderColor":"#efefef","color":"#333","borderWidth":"0","display":"none","width":"100%","lineHeight":"44px","fontSize":"15px","borderStyle":"solid","height":"44px"}'>个人信息</div>
		<div :style='{"borderColor":"#efefef","top":"40px","left":"40px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='nonghu'">
		...
		<div :style='{"borderColor":"#efefef","top":"40px","left":"40px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='yonghu'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"10px","borderWidth":"0 0 1px 0","display":"block","width":"100%","borderStyle":"solid","height":"100%"}' :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		...
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='nonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>性别</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.xingbie}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='nonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
		...
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='nonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>余额</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.money}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#333","fontSize":"14px","display":"none"}'>用户账号</div>
			<div :style='{"fontSize":"20px","color":"#000","textAlign":"left","flex":1,"fontWeight":"bold"}'>{{sessionForm.yonghuzhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","fontSize":"14px","display":"none"}'>用户姓名</div>
			<div :style='{"fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.yonghuxingming}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>性别</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.xingbie}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>用户电话</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.yonghudianhua}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>余额</div>
		...
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>是否会员</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.vip}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"65%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item class="balance" :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='nonghu'" label="余额">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
				<div @click="dialogFormVisibleMoney = true" :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","color":"rgba(255, 255, 255, 1)","display":"inline-block","outline":"none","borderRadius":"0","background":"#A293B6","width":"100px","lineHeight":"40px","fontSize":"14px","height":"40px"}'>点我充值</div>
			</div>
		  </el-form-item>
          ...
          <el-form-item class="balance" :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="会员">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				...
				<div @click="dialogFormVisibleVip = true" :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","color":"rgba(255, 255, 255, 1)","display":"inline-block","outline":"none","borderRadius":"0","background":"#A293B6","width":"100px","lineHeight":"40px","fontSize":"14px","height":"40px"}'>会员购买</div>
			</div>
		  </el-form-item>
          <el-form-item :style='{"padding":"0","margin":"0"}'>
            <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"5px","background":"#A293B6","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="onSubmit('sessionForm')">更新信息</el-button>
            <el-button :style='{"border":"none","cursor":"pointer","padding":"0","margin":"0","outline":"none","color":"#fff","borderRadius":"5px","background":"#9E9E9E","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="danger" @click="logout">退出登录</el-button>
          </el-form-item>
        </el-form>
      </el-tab-pane>
	  <el-tab-pane label="修改密码">
		<el-form class="center-preview-pv" ref="passwordForm" :model="passwordForm" :rules="passwordRules" label-width="80px">
			...
			<el-form-item :style='{"padding":"0","margin":"0"}'>
			  <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"5px","background":"#A293B6","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="updatePassword">修改密码</el-button>
			</el-form-item>
		</el-form>
	  </el-tab-pane>
