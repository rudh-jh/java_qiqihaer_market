...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 0 10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"1"}'>
      <el-form-item :style='{"margin":"0 10px 0px 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px 0 0","lineHeight":"42px","display":"inline-block"}'>课程标题：</div>
        <el-input v-model="formSearch.kechengbiaoti" placeholder="课程标题" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="btnAuth('nongjixuetang','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/nongjixuetangAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
		...
		<div class="list2 index-pv1" :style='{"padding":"0 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"padding":"25px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"10px 0","background":"#fff","display":"flex","width":"calc(50% - 10px)","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<div :style='{"border":"0","width":"220px","padding":"0","height":"110px"}'>
					<img @click.stop="imgPreView(item.kechengzhaopian)" :style='{"border":"1px solid #eee","width":"100%","objectFit":"contain","background":"#fff","display":"block","height":"100%"}' v-if="item.kechengzhaopian && item.kechengzhaopian.substr(0,4)=='http'" :src="item.kechengzhaopian.split(',')[0]" class="image" />
					<img @click.stop="imgPreView(baseUrl + (item.kechengzhaopian?item.kechengzhaopian.split(',')[0]:''))" :style='{"border":"1px solid #eee","width":"100%","objectFit":"contain","background":"#fff","display":"block","height":"100%"}' v-else :src="baseUrl + (item.kechengzhaopian?item.kechengzhaopian.split(',')[0]:'')" class="image" />
				</div>
				<div class="item-info" :style='{"padding":"10px","overflow":"hidden","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"auto"}'>
					<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"50%","lineHeight":"1","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"bold","order":"1"}' class="name ">{{item.kechengbiaoti}}</div>
