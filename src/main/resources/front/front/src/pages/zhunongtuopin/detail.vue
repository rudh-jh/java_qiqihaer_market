...
<div>
	...
	<div class="detail-preview" :style='{"width":"70%","margin":"10px auto","position":"relative","alignItems":"flex-start","flexWrap":"wrap","display":"flex"}'>
		<div class="attr" :style='{"padding":"0 10px","margin":"0 0 0 10px","background":"#f5f5f5","flex":"1","display":"flex","width":"calc(50% - 10px)","position":"relative","order":"2"}'>
			...
			<div class="info" :style='{"padding":"10px","margin":"0 0 0 10px","background":"none","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"4px 0","margin":"0 0 4px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#111","fontWeight":"700","textAlign":"left","width":"100px","fontSize":"14px","lineHeight":"28px","height":"28px"}'>文章编号</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#111","fontWeight":"700","flex":"1","height":"auto"}'>{{detail.wenzhangbianhao}}</div>
				</div>
				<div class="item" :style='{"padding":"4px 0","margin":"0 0 4px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#111","fontWeight":"700","textAlign":"left","width":"100px","fontSize":"14px","lineHeight":"28px","height":"28px"}'>文章分类</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#111","fontWeight":"700","flex":"1","height":"auto"}'>{{detail.wenzhangfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"4px 0","margin":"0 0 4px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#111","fontWeight":"700","textAlign":"left","width":"100px","fontSize":"14px","lineHeight":"28px","height":"28px"}'>发布时间</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#111","fontWeight":"700","flex":"1","height":"auto"}'>{{detail.fabushijian}}</div>
				</div>
				<div class="item" :style='{"padding":"4px 0","margin":"0 0 4px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#111","fontWeight":"700","textAlign":"left","width":"100px","fontSize":"14px","lineHeight":"28px","height":"28px"}'>文章简介</div>
					<div  :style='{"padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#111","fontWeight":"700","flex":"1","height":"auto"}'>{{detail.wenzhangjianjie}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","color":"#fff","outline":"none","borderRadius":"5px","background":"#A293B6","width":"32%","lineHeight":"40px","fontSize":"16px","height":"40px","order":"2"}' v-if="btnAuth('zhunongtuopin','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 0","margin":"0 20px 0 0","color":"#000","textDecoration":"underline","outline":"none","borderRadius":"4px","background":"none","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px","order":"6"}' v-if="btnAuth('zhunongtuopin','删除')" @click="delClick">删除</el-button>
					<!-- hasChat 无 -->
				</div>
			</div>
		</div>
		...
		<el-tabs class="detail" :style='{"border":"none","width":"100%","boxShadow":"none","margin":"20px 0 0","background":"#FFF","order":"5"}' v-model="activeName" type="border-card">
				...
				<div v-html="detail.wenzhangxiangqing"></div>
			</el-tab-pane>
