  ...
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="用户电话" prop="yonghudianhua">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'nonghu' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
